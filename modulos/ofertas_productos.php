...
global $mysqli;
?>
<p class="titulo_marca_detalle">PRODUCTOS EN OFERTA<p>
    <div class="contenedor_marca">
    <?php
    $strsql="SELECT `idproducto`, `nombre_producto`, `idcategoria`, `descripcion`, `precio`, `cantidad`, `url_imagen`, `fecha_creacion`, `idmarca`, `precio_oferta` FROM `productos` WHERE `precio_oferta`>0;";
                ...
                <a class ="ultimos_productos" href="?modulo=producto_detalles&id_producto=<?php echo $idproducto?>">
                    <div class="producto_detalle">
                        ...
                        <div class="producto_detalle_right">
                            ...
                            <h5 class="producto_precio_oferta">Precio: <b><?php echo "L" .number_format($precio,2)?></b></h5>
                            <h5 class="producto_oferta">Precio oferta: <b><?php echo "L" .number_format($precio_oferta,2)?></b></h5>
                        </div>
                    </div>
                </a>
            <?php
